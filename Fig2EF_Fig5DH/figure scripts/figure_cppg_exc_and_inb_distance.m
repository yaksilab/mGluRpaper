%% CPPG excitation and inhibition distance (new)
...
% load data
cppg = load(fullfile(acsfDir,'data.mat')); 

% organize data 
distE = vertcat(cppg.responses.distE);
distI = vertcat(cppg.responses.distI);
